...
//        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont boldSystemFontOfSize:15];
        [_leftBtn setTitleColor:KUIColorFromRGB(0x23A0F0) forState:UIControlStateNormal];
...
//        _rightBtn.layer.masksToBounds = YES;
        ...
        [_rightBtn setTitleColor:KUIColorFromRGB(0x23A0F0) forState:UIControlStateNormal];
