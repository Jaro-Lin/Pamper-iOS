...
@property(nonatomic,   assign) UIEdgeInsets limitMargin;//

@property(nonatomic, copy) NSNumber *spaceLine;

@property(copy, nonatomic) NSString *limitPlaceholder;
/** 剩余 字数 提示样式 ## 替换为剩余数字 如  ”还剩##字“  即 “还剩220字”*/
@property(copy, nonatomic) IBInspectable NSString *limitStyle;
