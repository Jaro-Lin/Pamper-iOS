//
//  SYRecordNoticeViewController.m
//  SYBaseProject
//
...
@interface SYRecordNoticeViewController ()<WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate>
...
@implementation SYRecordNoticeViewController
...
- (void)viewDidLoad {
    ...
    if (!kStringIsEmpty(self.contentStr)) {
        self.contentTextView = [[UITextView alloc]initWithFrame:CGRectMake(17, 20, kScreenWidth-34, kScreenHeight-KNavBarHeight-30)];
        self.contentTextView.textColor = RGBOF(0x333333);
...
- (WKWebView *)webView{
    if(_webView == nil){
        ...
        _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0,KScreenWidth, KScreenHeight-KNavBarHeight) configuration:config];
        // UI代理
